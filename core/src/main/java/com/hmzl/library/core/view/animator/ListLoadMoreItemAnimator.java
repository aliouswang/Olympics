package com.hmzl.library.core.view.animator;
 ...
 */
public class ListLoadMoreItemAnimator extends SimpleItemAnimator{
    ...
    public ListLoadMoreItemAnimator(Context context) {
